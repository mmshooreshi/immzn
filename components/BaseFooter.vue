...
<template>
  <NuxtLayout name="section">
    <footer class="!gap-2 footer">
      ...
      <div class="text-left md:text-center justify-center flex flex-row font-mono  text-gray/80"><small class="leading-[15px] love ">Made with </small><Icon class="bg-red w-6 h-[15px]" name="nrk:heart-active"/><small class="leading-[15px] "> by <span class=" border-teal/80 border-0 border-b-1 border-solid"> <a class="text-teal/80" href="https://github.com/mmshooreshi" target="_blank">mmti <Icon name="mdi:robot-love"/></a></span></small></div>
