        ...
        <section class="flex bg-white w-full md:w-1/2 items-center justify-center p-8 h-screen">
            <form @submit.prevent="submit" class="w-full max-w-lg space-y-6" novalidate>
                ...
                <div>
                    ...
                    <input v-model="form.email" id="email" type="email" required class="input"
                ...
                <div class="flex items-center">
                    ...
                    <label for="newsletter" class="ml-2 text-sm text-gray-700 dark:text-gray-300">Send me occasional
                        updates about ImmUnity Horizons</label>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                        I agree to the
                        <a href="/terms" target="_blank" class="text-indigo-600 underline">terms &amp; conditions</a>
                    </label>
                </div>
